...
<header>
	...
	<div class="heroe">
		...
		<h2> Pour reporting | convertion excel en csv | extractions </h2>
	</div>
...
<section>
	...
	<h1>Pour commencer, sélectionné un fichier <zz style="opacity:0.5" >[.excel ou]</zz> .csv</h1>
	...
	<pre><code></code></pre>
	-->
	<form method="post" action="<?= site_url('home/convert') ?>" enctype="multipart/form-data">
			<div class="input-group" style="width:70%">
				<input type="file" class="form-control" id="inputGroupFile04" aria-describedby="inputGroupFileAddon04" aria-label="Upload" accept="*.csv, *.xlsx, *.xls" name="file" required>
			</div>
			<br>
			<button class="btn btn-secondary" type="submit" id="inputGroupFileAddon04" style="width:70%">Valider</button>
	</form>
